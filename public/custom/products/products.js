...
var oTable = $('#products').DataTable( {"sPaginationType": "full_numbers"} );
...
//   });
jQuery('#products_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
jQuery('#products_wrapper .dataTables_length select').addClass("m-wrap xsmall"); // modify table per page dropdown
...
function SuccessHandler(data) {
	...
	$.each(data.data.docs, function (i, obj) {
		var rowIndex =  oTable.fnAddData( [
			...
			data.data.docs[i].category,
			data.data.docs[i].currency + " " + data.data.docs[i].price,
			data.data.docs[i].discount,
			data.data.docs[i].quantity,
			...
			'<a href="productsview?id=' + data.data.docs[i]._id + '" class="btn mini blue" title="View Product"><i class="icon-share"></i></a> &nbsp; <a href="productsedit?id=' + data.data.docs[i]._id + '" class="btn mini purple" title="Edit Product"><i class="icon-edit"></i></a> &nbsp; <a href="" class="btn mini black delete" title="Delete Product"><i class="icon-trash"></i></a> &nbsp; <a href="admusersview?id=' + data.data.docs[i].webid + '" class="btn mini red-stripe" title="View User"><i class="fa fa-user" aria-hidden="true"></i></a>',
		] );
...
$('#products a.suspend').live('click', function (e) {
	e.preventDefault();
...
$('#products a.resume').live('click', function (e) {
	e.preventDefault();
...
// 	var product_web = $("#product_web").val();
...
// 	}
// 	if (product == "") {
// 		$("#dvproduct").addClass("error");
// 		$("#dvproduct .help-inline").show().text("Please enter product.");
// 		chk = 1;
// 	}
// 	else if (ValidText(product,0,255)) {
// 		$("#dvproduct").addClass("error");
// 		$("#dvproduct .help-inline").show().text("250 Characters allowed.");
// 		chk = 1;
// 	}
// 	if (product_web == "") {
// 		$("#dvproduct_web").addClass("error");
// 		$("#dvproduct_web .help-inline").show().text("Please enter product web.");
// 		chk = 1;
// 	}
// 	else if (ValidText(product_web,0,500)) {
// 		$("#dvproduct_web").addClass("error");
// 		$("#dvproduct_web .help-inline").show().text("500 Characters allowed.");
// 		chk = 1;
// 	}
// 	if (medium == "") {
